...
class RInstruction(InstructionType):
    ...
    def decode(self, opcode, funct3, funct7, alu, ex_code=None):
        ...
        return InstructionSignal(eq, alu)
...
class IInstruction(InstructionType):
    ...
    def decode(self, opcode, funct3, alu, cond , ex_code ,ex_code2):
        ...
        return InstructionSignal(eq, alu, cond=cond)

class SInstruction(InstructionType):
...
class JInstruction(InstructionType):
...
class BInstruction(InstructionType):
    ...
    def decode(self, opcode, funct3, cmp, flip):
        ...
        funct3 = view.funct3 == Bits(3)(funct3)
        eq = opcode & funct3
        return InstructionSignal(eq, RV32I_ALU.ALU_ADD, cond=(cmp, flip))
